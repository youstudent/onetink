...
<body>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!empty($rows)): if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($channel['status']==1?'已处理':'未处理'); ?></td>
						<td>
							<a title="编辑" href="<?php echo U('edit?id='.$channel['id'].'&pid='.$pid);?>">编辑</a>
							<a title="查看详情" href="<?php echo U('detail?id='.$channel['id'].'&pid='.$pid);?>">查看详情</a>
